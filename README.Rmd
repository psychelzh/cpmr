...
The cpmr package is specifically designed for the analysis of the connectome predictive modeling (CPM) method in R. This package relies on [Rfast](https://cran.r-project.org/web/packages/Rfast/index.html) to do row oriented calculation.
