...
You can install the development version of cpmr from [GitHub](https://github.com/) with:
...
Or you can install cpmr from [r-universe](https://psychelzh.r-universe.dev) with:
