...
fit(rich_spec, conmat = conmat, behav = behav)$predictions |>
  head()
#>   row        real difference
#> 1   1  0.26499342 0.86635240
#> 2   2  1.83074748 2.01198432
#> 3   3 -0.05937826 0.35788717
#> 4   4 -0.05320937 0.01084592
#> 5   5  0.43790418 0.54128500
#> 6   6  1.33744904 1.38812964
```

This lets you control edge screening, thresholding, edge weighting,
network-strength construction, and the final prediction head from one reusable
spec object.
